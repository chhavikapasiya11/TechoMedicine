...
const generateToken = (userId, expiresIn = "30d") => jwt.sign({ userId }, JWT_SECRET, { expiresIn });
...
/*
  ...
  router.post("/patient", async (req, res) => {
    try {
      const { userId, age, gender, medicalHistory, contactNumber } = req.body;
      ...
      console.error("Error in /patient route:", error); // Log full error
